...
<body>
	...
	<div class="container">
		<div class="header text-center">
			...
			<input type="hidden" name="cate" value="스킨케어-스킨/로션">
				<input class="inpName input_field" placeholder="상품명" type="text" name="pname">
				<input class="minPrice input_field" placeholder="최소가격" type="number"
					name="minPrice"> <input class="maxPrice input_field" placeholder="최대가격"
