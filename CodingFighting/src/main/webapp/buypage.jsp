				...
				<div class="input-form col-md-12 mx-auto">
					...
					<div class="mb-3">
						<label for="address">연락처</label> <input type="text"
							class="form-control" name="phonNum" value="<%=DTO.getPhonNum()%>">
